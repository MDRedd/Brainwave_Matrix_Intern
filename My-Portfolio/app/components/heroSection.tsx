...
const HeroSection: React.FC = () => {
  return (
    <section
      id="home"
      className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-blue-900 via-purple-800 to-indigo-700 text-white text-center p-4"
    >
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-2xl mb-6 text-gray-400">
          Hi! I'm DronaReddy, a UI/UX WEb developer.
        </p>
        <Link href="#projects">
